  ...
  const normalizedPreview = useMemo(() => {
    ...
    return preview.map((row) => {
      ...
      return {
        ...
        vehicle_make: get(row, 'make') || parsed.make || null,
        vehicle_model: get(row, 'model') || parsed.model || null,
        // WHY: Build vehicle_of_interest from parts if veh is empty string.
        // Empty JSON Vehicle Title produced a bare comma in the Leads vehicle column.
    ...
    try {
      ...
      for (const row of effectiveRows) {
        ...
        toInsert.push({
          ...
          dedup_hash: hash,
          // WHY: Build vehicle_of_interest from parts if JSON Vehicle Title is empty.
